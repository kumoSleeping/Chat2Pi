...
let packageDir = dirname(fileURLToPath(import.meta.resolve("@earendil-works/pi-coding-agent")));
while (!existsSync(join(packageDir, "package.json")))
    packageDir = dirname(packageDir);
export const piVersion = JSON.parse(readFileSync(join(packageDir, "package.json"), "utf8")).version;
const factories = {
...
export function checkPath(workspace, value) {
