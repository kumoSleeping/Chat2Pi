...
import { agentSchema, readPrivate, savePrivate, requireSecureUrl, } from "./config.js";
...
export async function accountCommand(command, o) {
    ...
    if (command === "device-import") {
        if (!o.bundle || !o.workspace)
            throw Error("device-import requires --bundle download.json --workspace path");
        ...
        const tools = binding.tools.filter((t) => o.unrestricted || ["read", "ls", "find", "grep"].includes(t));
