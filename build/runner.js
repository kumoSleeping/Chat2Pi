    ...
    async call(deviceId, name, args) {
        ...
        try {
            return await new Promise((resolve, reject) => {
                ...
                const timer = setTimeout(() => finish(new Error("Tool timed out; side effects may have occurred. Do not retry automatically.")), this.device.timeout_seconds * 1000);
                this.stop = () => finish(new Error("Device disconnected; operation cancelled. Side effects may have occurred."));
